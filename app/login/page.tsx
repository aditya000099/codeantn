...
const Page = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen">
            ...
            {/* Right side - adjust box height and policy text positioning */}
            <div className="w-full md:w-1/2 bg-gray-50 flex-col flex items-center justify-center border-l border-gray-200 border-s shadow-sm p-4 min-h-screen">
                <div className="w-full max-w-[680px] bg-white rounded-lg border border-gray-200 px-4 md:px-0 my-auto">
                    ...
                    <div className="min-h-[600px] flex flex-col">
                        ...
                        <div className="space-y-4 md:space-y-6 border-t-2 border-gray-200 mb-6 md:mb-10 px-4 md:px-32 pt-5 flex-grow">
                            {isLogin ? (
...
>>>>>>> dad9112 (fix)
                ...
                <Text className="text-center mt-4 text-black text-xs md:text-sm font-inter-regular px-4">
